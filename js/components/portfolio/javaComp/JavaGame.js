...
export default class JavaGame extends React.Component{
          ...
          <div class="portfolio_block">
            <div className="javascriptSummary">
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/JavaGame/newGame.png" className="portfolio_block_image_summary" alt="java game image"/>
              </div>
              <br /><br />

              <p>
                Source code: <a href="https://github.com/nialloc9/java-game">GitHub</a>
              </p>

              <br /><br />

              <p>
                This is a 2d game made using the slick2d library. The object of the game is to find a secret door in the wall. The door is hidden so it is a trial and error approach. The game features scenes for the menu and the game.
              </p>
              ...
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/JavaGame/mainMenu.png" className="portfolio_block_image_summary" alt="java game main menu image"/>
              </div>
              ...
              <ol>
                Give it a reference number(will be used when changing states)<br />
                Add it as a state to the StateBasedGame object<br />
                Initialize the state<br />
              </ol>
...
{`
  ...
  `}
            ...
            <div className="portfolio_block_image_summary_wrapper">
              <img src="../../../resources/images/projects/JavaGame/collisionCantContinue.png" className="portfolio_block_image_summary" alt="java game image"/>
            </div>
...
{`
  ...
  `}
            ...
            <div className="portfolio_block_image_summary_wrapper">
              <img src="../../../resources/images/projects/JavaGame/winner.png" className="portfolio_block_image_summary" alt="java game image"/>
            </div>
            </div>
          </div>
      </div>
