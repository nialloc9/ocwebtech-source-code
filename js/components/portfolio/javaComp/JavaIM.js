...
export default class JavaIM extends React.Component{
          ...
          <div class="portfolio_block">
            <div className="javascriptSummary">
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/JavaIm/instant_messenger_in_operation.png" className="portfolio_block_image_summary" alt="java instant messenger image"/>
              </div>
              <br /><br />

              <p>
                Source code: <a href="https://github.com/nialloc9/java_simple_calculator">GitHub</a>
              </p>
...
{`
  ...
  `}
              ...
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/JavaIm/burningHouse.png" className="portfolio_block_image_summary" alt="java instant messenger image"/>
              </div>
              <br /><br />
