...
export default class JavaCalc extends React.Component{
          ...
          <div class="portfolio_block">
            <div className="javascriptSummary">
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/JavaCalc/running.png" className="portfolio_block_image_summary" alt="java calculator image"/>
              </div>
              <br /><br />
