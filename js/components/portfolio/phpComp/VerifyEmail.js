          ...
          <div class="portfolio_block">
            <div className="javascriptSummary">
              <div className="portfolio_block_image_summary_wrapper">
                <img src="../../../resources/images/projects/verifyEmail/emailReceived.png" className="portfolio_block_image_summary" alt="email verification image"/>
              </div>
              <br /><br />

              <p>
                This project is used to create a confirmation request email for a user’s email account. This is very important for things such identity identification and
                password retrieval. This project uses two main scripts with other smaller scripts for connecting to the database
                that we won’t be discussing but the source code will be provided.
              </p>

              <br /><br />

              <p>
                Source Code: <a href="https://github.com/nialloc9/emailAuthenticate">GitHub</a>
              </p>
